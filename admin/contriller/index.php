        ...
        <div class="col-md-6 offset-md-3">
            ...
            <form class="shadow p-4" method="POST" action="index.php">                  
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="cat_type_name" id="cat_type_name" placeholder="Category Type Name">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="cat_type_code" id="cat_type_code" placeholder="Category Type Code">
